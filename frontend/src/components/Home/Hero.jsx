...
const Hero = () => {
  return (
    <div className='h-[75vh] flex'>
        <div className='lg:w-3/6 flex flex-col lg:items-start justify-center'>
            ...
            <p className='mt-4 text-xl text-zinc-300'>Uncover captivating stories, enriching knowledge, and endless 
            inspiration in our curated collection of books</p>
            <div className='mt-8'>
                <div className='mt-8'>
        ...
        <div className='w-full lg:w-3/6 h-auto lg:h-[100%] flex items-center justify-center'>
          <img src='images.jpg' alt='image' className=''></img>
        </div>
    </div>
  )
}
